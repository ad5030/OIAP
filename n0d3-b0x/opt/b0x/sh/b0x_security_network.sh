...
# V1.0 [2020-06-01]
#-------------------------------------------------------------------
#~ Usage : b0x_security_network.sh whitelist france
#-------------------------------------------------------------------
#
...
curlout=`/usr/bin/curl $GEOIP_URL -o $GEOIP_FILE 2>&1`
...
-A INPUT -m set ! --match-set whitelist4 src -j DROP
COMMIT
*nat
