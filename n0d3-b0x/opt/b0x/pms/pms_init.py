...
print("\r\n")
print("************* Others **************")
#print("Setting Watchdog Status: " + str(api.setWatchdogStatus(0)))
#print("Getting Watchdog Status: " + str(api.getWatchdogStatus()))
#print("RGB Animation Result: " + str(api.setRgbAnimation(3,3,3)))
#print("RGB Animation: " + str(api.getRgbAnimation()))
...
print("Result Safe Shutdown Bat Status.: " + str(api.set_safe_shutdown_battery_status(0)))
